        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-12 order-lg-2 order-1">
                    @if ($product_category->thumbnail != NULL || $product_category->thumbnail != '')
                        <div class="category-image mb-30">
                            <a href="javascript:void(0)"><img src="{{ MyHelper::get_uploaded_file_url($product_category->thumbnail) }}" alt="banner" /></a>
                        </div>
                    @endif
					<div class="section-title-5 mb-30">
						<h2>{{ __('messages.label_category') }}: {{ $product_category->name }}</h2>
					</div>
                    <hr>
                    <!-- tab-area-start -->
